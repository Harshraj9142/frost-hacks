...
export default function FacultyAuthPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:flex-1 relative items-center justify-center p-12 bg-gradient-to-br from-emerald-500/10 via-background to-background overflow-hidden">
        {/* Gradient Orbs */}
        ...
        >
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            Empower Your Students with AI Insights
          </h1>
          <p className="text-lg text-muted-foreground mb-8">
            Track progress, identify learning gaps, and manage course materials with powerful analytics.
          </p>

          <div className="space-y-4">
            {[
              { icon: Users, text: "Monitor student engagement" },
              { icon: BarChart3, text: "Detailed learning analytics" },
              { icon: FileText, text: "Easy course material management" },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/student/auth" className="text-primary hover:underline font-medium">
              Student Login
            </Link>
          </div>
        </motion.div>
